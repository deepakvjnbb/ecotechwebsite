import prodpic1 from './prod/water3.jpg'
import prodpic2 from './prod/ROPlant.jpg'
import prodpic3 from './prod/ManualSoftenerPlant.jpg'
import prodpic4 from './prod/Sandfiltersr1.jpg'
import prodpic5 from './prod/dmplantr2.jpg'
import prodpic6 from './prod/swimmingpoolr1.jpg'
...
const people = [
  ...
  {
    name: 'Zero Maintenance Water Softners',
...
export default function ProductSection() {
    ...
    <div id="ourproducts" className="bg-white py-24 md:py-32 lg:py-40">
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          Our water purifiers provide clean and safe drinking water by effectively removing impurities and contaminants. Using advanced filtration methods like Reverse Osmosis (RO), Ultraviolet (UV) treatment and Ultra filtration(UF). Our products ensure that you enjoy great-tasting water while promoting a healthier lifestyle. With efficient designs, they are easy to use and maintain, making pure water accessible for you and your family.
           </p>
        </div>
        <ul
          role="list"
  ...
  <li key={person.name} className="relative">
    <div className="relative">
      ...
      />
      <div className="absolute inset-0 bg-grey-300 bg-opacity-30 rounded-2xl"></div>
    </div>
