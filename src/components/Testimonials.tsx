...
const testimonials = [
  {
    id: 1,
    body: 'I installed a water filtration system from ecotech , and the difference is amazing! The water tastes better, and I feel confident it’s safe for my family. The installation was quick, and the team was very professional. Highly recommend their products!',
    author: {
      name: 'Mr.Surentheran - Owner',
      company:' Hi-tech Cottons  ',
      // imageUrl: img,
    },
  },
  {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-xl text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Here is what our valued customers say about our products and projects
          </p>
        </div>
